...
assert_contains ".config/mise/config.wsl.toml" '[tasks."bootstrap:for_env"]'
assert_contains ".config/mise/config.wsl.toml" 'export WSLENV'
...
assert_contains ".config/zsh/conf.d/os/wsl/10-1password.zsh" 'export WSLENV'
