...
alias upd="brew update; brew upgrade; vi --headless +PlugUpdate +qall; omz update; zinit self-update; pip install --upgrade pip pynvim tmuxp; echo Updates completed at $(date)"
