...
alias upd='brew update; brew upgrade; zinit self-update; zinit update --all; pip install --upgrade pip pynvim tmuxp; npm i -g npm neovim @openai/neovim; echo Updates completed at $(date)'
