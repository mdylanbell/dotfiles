...
alias upd="brew update; brew upgrade; vi --headless +PlugUpdate +qall; omz update; zplug update; pip install --upgrade pip pynvim tmuxp; echo Updates completed at $(date)"
