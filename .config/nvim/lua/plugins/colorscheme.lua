return {
...

  {
    ...
    config = function(_, opts)
      ...
      -- --- Terminal ANSI palette: apply only for Solarized Dark
      ...
      vim.api.nvim_create_autocmd("UIEnter", { group = group, once = true, callback = apply_or_clear })
      vim.api.nvim_create_autocmd("ColorScheme", { group = group, callback = apply_or_clear })

      -- Optional: tidy terminal window highlights (window-local, set after it opens)
