...
config.mouse_bindings = {
	-- Right click: always paste (no heuristic / no copy behavior)
	-- {
	-- 	event = { Down = { streak = 1, button = "Right" } },
	-- 	mods = "NONE",
	-- 	action = act.PasteFrom("Clipboard"),
	-- },
	-- Copy completed mouse selections to the system clipboard only.
	-- Leave right click and default keybindings alone.
	{
